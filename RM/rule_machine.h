...
namespace rm // rule machine
{
    ...
    public:
        ...
        result_t add_link(id_t event_id, InitialState* state_source, State* state_target, Transition* trans = nullptr)
        {
        ...
        result_t add_link(id_t event_id, State* state_source, FinalState* state_target, Transition* trans = nullptr)
        {
