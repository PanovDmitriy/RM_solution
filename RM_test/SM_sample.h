...
//{
//    std::cout << "action1: event: " << ref_e.id.to_string() << std::endl;
//}
//
//void action2(const Event& ref_e)
//{
//    std::cout << "action2: event: " << ref_e.id.to_string() << std::endl;
//}
//
//bool guard_always_false(const Event& ref_e)
//{
//    std::cout << "guard_always_false: event: " << ref_e.id.to_string() << std::endl;
//    return false;
//}
//
//bool guard_always_true(const Event& ref_e)
//{
//    std::cout << "guard_always_true: event: " << ref_e.id.to_string() << std::endl;
//    return true;
//}
//
//void main_SM()
...
//    //final_state sf;
//
//    TransitionTest tinit1("trans init->1");
//    TransitionTest tinit2("trans init->2");
//    TransitionTest tinit3("trans init->3");
//    TransitionTest tfinal1("trans 1->final");
//    TransitionTest tfinal2("trans 2->final");
//    TransitionTest tfinal3("trans 3->final");
//    TransitionTest t12("trans 1->2");
//    TransitionTest t21("trans 2->1");
//    TransitionTest t23("trans 2->3");
//    TransitionTest t32("trans 3->2");
//    TransitionTest t13("trans 1->3");
//    TransitionTest t31("trans 3->1");
//
...
//        }
//        std::cout << "strike [" << i+1 << "] event: " << ee->id.to_string() << std::endl << "<" << std::endl;
//        sm.rise_event(*ee);
